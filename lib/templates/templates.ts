...
const defaults: Record<NodeType, Omit<CanvasNodeData, "nodeType" | "title" | "status">> = {
  ...
  video: { prompt: "A gentle cinematic movement", duration: 5, aspectRatio: "16:9", referenceImageUrl: "", model: "", resolution: "", fps: "", videoProvider: "kling", videoInputMode: "text-to-video", tokenstarMode: "text-to-video", generateAudio: true, referenceImageAssetUrl: "", referenceVideoAssetUrl: "", referenceAudioAssetUrl: "" },
